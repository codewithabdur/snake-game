...
let fail = new Audio("audio/fart.mp3")
...
function incrementScore() {
  ...
  function initialize() {
    ...
    h1.innerText="Welcome to the Snake Game! Press an arrow key to start the game.";
 ...
 window.onload = function music(){
  ...
  volumeIcon.addEventListener('click', function() {
    if (this.classList.contains('bi-volume-up')) {
      sound.pause();
